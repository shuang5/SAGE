...
threads.append(Thread(target=nonblockingshortestpath, args=("manifest1.rdf",1,4)))
# threads.append(Thread(target=nonblockingshortestpath, args=("manifest1.rdf",1,5)))
# threads.append(Thread(target=nonblockingshortestpath, args=("manifest1.rdf",1,7))) 
# threads.append(Thread(target=nonblockingshortestpath, args=("manifest1.rdf",1,8))) 
# threads.append(Thread(target=nonblockingshortestpath, args=("manifest1.rdf",1,9)))
# threads.append(Thread(target=nonblockingshortestpath, args=("manifest1.rdf",1,10)))
...
threads.append(Thread(target=nonblockingshortestpath, args=("interdomain",1,5)))
threads.append(Thread(target=nonblockingshortestpath, args=("interdomain",1,2))) 
threads.append(Thread(target=nonblockingshortestpath, args=("interdomain",1,3))) 
threads.append(Thread(target=nonblockingshortestpath, args=("interdomain",1,4)))
# threads.append(Thread(target=nonblockingshortestpath, args=("interdomain",1,5)))
...
threads.append(Thread(target=shortestpath, args=("mp-manifest",1,5))) 
threads.append(Thread(target=shortestpath, args=("mp-manifest",1,2))) 
threads.append(Thread(target=shortestpath, args=("mp-manifest",1,3))) 
threads.append(Thread(target=shortestpath, args=("mp-manifest",1,4))) 
threads.append(Thread(target=shortestpath, args=("mp-manifest",1,5))) 
...
# threads.append(Thread(target=nonblockingshortestpath, args=("mp-manifest",1,5)))
threads.append(Thread(target=nonblockingshortestpath, args=("mp-manifest",1,2))) 
threads.append(Thread(target=nonblockingshortestpath, args=("mp-manifest",1,3))) 
threads.append(Thread(target=nonblockingshortestpath, args=("mp-manifest",1,4)))
# threads.append(Thread(target=nonblockingshortestpath, args=("mp-manifest",1,5)))
# threads.append(Thread(target=nonblockingshortestpath, args=("mp-manifest",1,6))) 
# threads.append(Thread(target=nonblockingshortestpath, args=("mp-manifest",1,7))) 
# threads.append(Thread(target=nonblockingshortestpath, args=("mp-manifest",1,8)))
# threads.append(Thread(target=nonblockingshortestpath, args=("mp-manifest",1,9)))
time1=datetime.now()
for t in threads:
    t.start()
